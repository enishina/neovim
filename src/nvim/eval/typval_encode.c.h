...
#define DEFINE_TYPVAL_ENCODE_CONVERT_ONE_VALUE(typval_encode_scope, typval_encode_name, typval_encode_first_arg_type, typval_encode_first_arg_name) \
static int _TYPVAL_ENCODE_CONVERT_ONE_VALUE( \
	typval_encode_first_arg_type typval_encode_first_arg_name, \
	MPConvStack *const mpstack, MPConvStackVal *const cur_mpsv, \
	typval_T *const tv, const int copyID, \
...
#define DECLARE_TYPVAL_ENCODE_ENCODE(typval_encode_scope, typval_encode_name, typval_encode_first_arg_type, typval_encode_first_arg_name) \
